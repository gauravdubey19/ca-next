...
export default function JoinUs() {
  ...
  return (
    <section
      ref={ref}
      className="w-full h-[30vh] md:h-[50vh] lg:h-[70vh] flex-center bg-[url(https://www.jagranimages.com/images/newimg/09022023/09_02_2023-office_meeting_tips_f_23323658.jpg)] bg-cover bg-center bg-no-repeat"
    >
      <div className="w-full h-full container grid grid-cols-1 md:grid-cols-2 items-center gap-8 bg-black/60 px-4 md:px-32">
        <div className="space-y-4">
          ...
          <motion.h2
            ...
            initial="hidden"
            animate={isInView ? "show" : "exit"}
            className="flex flex-wrap md:flex-col gap-2 text-xl md:text-3xl lg:text-4xl font-bold tracking-wider text-[#fff] relative"
          >
        ...
        >
          <div className="flex w-full max-w-md items-center bg-white space-x-2 rounded-lg p-2">
            ...
            />
            <Button className="bg-[#FDC24C] hover:bg-[#fdc24cd8] text-black fill-black space-x-1 p-4 md:p-6">
